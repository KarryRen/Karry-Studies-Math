...
中心极限定理的定义：如果按照我们之前推算多维随机变量函数分布的做法，对于 $2$ 维、$3$ 维等情况推出 $Y$ 的精确分布可能并不难，但对于 $100$ 维就太复杂了。通过对小维度随机变量的规律探索，发现序列和这一随机变量会随着所加和序列维度的增加愈发接近于正态分布。正是基于这个发现，我们想探究 $n$ 维随机变量序列和的分布与正态分布之间的关系，更具体的是看标准化后的随机变量
$$
